...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/00a6cb2023c6b5dd8e3c2.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/00a6cb2023c6b5dd8e3c2.jpg"
          alt="logo"
        />
        <a href="https://t.me/VijayAdithyaa"> 
          <h2 class="name">✗³𝙲𝚘𝚍𝚒𝚗𝚐</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/hey-adithya/Bharat-Torrent-Pro-Bot"><i class="fab fa-github"></i></a>
...
<body>
   <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/https://github.com/hey-adithya/Bharat-Torrent-Pro-Bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/VijayAdithyaa"><iclass="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    return web.Response(
        text='<h1>🤗TorToolkitX webserver is Up and Running successfully🟢</h1>\n<h2>⚡See ✗³𝙲𝚘𝚍𝚒𝚗𝚐 on <a href="https://github.com/hey-adithya/Bharat-Torrent-Pro-Bot">@GitHub</a></h2>\n<h2>🥲Join ✗³𝙲𝚘𝚍𝚒𝚗𝚐 <a href="https://t.me/VijayAdithyaa">TG channel</a></h2>',
